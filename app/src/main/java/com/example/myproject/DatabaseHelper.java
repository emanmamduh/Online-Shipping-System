...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public Boolean insertData(String email, String password,String username,String phone,String card,String cvc,String cardyear,String birthdate){
        ...
        contentValues.put("cardyear", cardyear);
    ...
    private void notifyObservers(boolean success) {
        for (UpdateObserver observer : observers) {
            observer.onDataUpdated(success);
        }
    }

    public boolean updateData(int userId, String updatedEmail, String updatedUsername, String updatedPhone) {
        SQLiteDatabase myDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        ...
        if (!TextUtils.isEmpty(updatedUsername)) {
            contentValues.put("username", updatedUsername);
        }
        if (!TextUtils.isEmpty(updatedPhone)) {
            contentValues.put("phone", updatedPhone);
        }
        int rowsAffected = myDatabase.update("users", contentValues, "id=?", new String[]{String.valueOf(userId)});

        myDatabase.close();
        notifyObservers(rowsAffected > 0);
    ...
    public User getUserByEmail(String email) {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                ...
                user = new User(userId, userEmail, username, phone);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public List<User> getUser() {
        ...
        try {
            while (cursor != null && cursor.moveToNext()) {
                ...
                String username = cursor.getString(usernameColumnIndex);
                String phone = cursor.getString(phoneColumnIndex);
                User user = new User(retrievedUserId, userEmail, username, phone);
                userList.add(user);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public List<User> getUsers() {
        ...
        try {
            while (cursor != null && cursor.moveToNext()) {
                ...
                int usernameColumnIndex = cursor.getColumnIndex("username");
                int phoneColumnIndex = cursor.getColumnIndex("phone");
                int cardColumnIndex = cursor.getColumnIndex("card");
                int cvcColumnIndex = cursor.getColumnIndex("cvc");
                int yearColumnIndex = cursor.getColumnIndex("cardyear");
                int retrievedUserId = cursor.getInt(idColumnIndex);
                String userEmail = cursor.getString(emailColumnIndex);
                String username = cursor.getString(usernameColumnIndex);
                String phone = cursor.getString(phoneColumnIndex);
                String card = cursor.getString(cardColumnIndex);
                String cvc = cursor.getString(cvcColumnIndex);
                String year = cursor.getString(yearColumnIndex);

                User user = new User(retrievedUserId, userEmail, username, phone,card,cvc,year);
                userList.add(user);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean deleteuserById(int categoryId) {
        ...
        return db.delete("users", "id=?", new String[]{String.valueOf(categoryId)}) > 0;
    }
    public User getUserById(int userId) {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                ...
                user = new User(retrievedUserId, userEmail, username, phone);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public boolean UpdateProduct(int productId, String name, String description, byte[] image, String barcode, int catId, int price,int sale, int quantity) {
        SQLiteDatabase MyDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("name", name);
    ...
    public List<Product> getAllProducts() {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                ...
                int saleColumnIndex = cursor.getColumnIndex("sale");
                ...
                do {
                    ...
                    Product product = new Product(productId, productName, productDescription, productImage,productbarcode ,productCategory, productPrice,  productsale, productQuantity);
    ...
    public Product getProductByBarcode(String barcode) {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                ...
                product = new Product(productId, productName, productDescription, productImage, barcode, categoryId, productPrice, productsale, productQuantity);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    ...
                    int productsale = cursor.getInt(saleColumnIndex);
                    String productQuantity = cursor.getString(quantityColumnIndex);
                    Product product = new Product(productIdFromCursor, productName, productDescription, productImage,productbarcode, productCategory, productPrice,productsale, productQuantity);
                    products.add(product);
                } while (cursor.moveToNext());
            }
        } catch (Exception e) {
    ...
    public List<Product> searchProducts(String searchText) {
        ...
        SQLiteDatabase myDatabase = this.getReadableDatabase();
        String[] projection = {"id", "name", "description", "image", "category", "price", "quantity"};
        ...
        try {
            while (cursor != null && cursor.moveToNext()) {
                ...
                if (idIndex != -1 && nameIndex != -1 && descriptionIndex != -1 &&
                        imageIndex != -1 && categoryIndex != -1 && priceIndex != -1 && quantityIndex != -1) {
                    ...
                    Product product = new Product(id, name, description, image, barcode,category, price,sale, quantity);
    ...
    public Product getOneProduct(int productId) {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                ...
                int productsale = cursor.getInt(saleColumnIndex);
                String productQuantity = cursor.getString(quantityColumnIndex);
                product = new Product(fetchedProductId, productName, productDescription, productImage,productbarcode ,productCategory, productPrice, productsale, productQuantity);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public boolean insertShoppingCartItem(ShoppingCartItem shoppingCartItem) {
        SQLiteDatabase MyDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("userId", shoppingCartItem.getuserId());
        contentValues.put("proId", shoppingCartItem.getproductId());
        contentValues.put("quantity", shoppingCartItem.getquantity());
        contentValues.put("totalprice", shoppingCartItem.gettotalPrice());
